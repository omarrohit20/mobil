...
public class AppiumFactory {
    private static Logger LOGGER = Logger.getLogger(AppiumDriverType.class.getName());
    ...
    private static boolean USE_SELENIUM_GRID = Boolean.getBoolean("useSeleniumGrid");
    ...
    private void instantiateWebDriver(AppiumDriverType appiumDriverType) {
        ...
        if (USE_SELENIUM_GRID) {
            ...
            try {
                seleniumGridURL = new URL("http://localhost:4444/wd/hub");
            ...
            driver = appiumDriverType.createAppiumObject(seleniumGridURL, desiredCapabilities).getAppiumDriver();
        } else {
